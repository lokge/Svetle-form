...
<div class="form-container">
    <form method="post" class="main-form" on:submit={validateForm}>
        ...
        <div class="form-body">
            ...
            <Input registerInput={registerInput} type="number" id="phone-input" name="phone" inputCaption="Phone" inputIsRequired={true} />
            <Input registerInput={registerInput} type="text" id="subject-input" name="subject" inputCaption="Subject" inputIsRequired={true} />
